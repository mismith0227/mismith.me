...
export const biographies = [
  ...
  },
  {
    ...
    title: 'webサービス会社',
    detail:
      '自社運営サービスのデザイナー。サービスの新規会員やアクティブユーザーの獲得、有料会員への誘導方法などを考える仕事でした。',
  ...
  },
  {
    ...
    title: '制作会社',
    detail:
      '制作会社のマークアップエンジニア。大手のコーポレートサイトや会員制サービスサイトから、大学入試サイト、ECサイト、スマホゲームなど幅広い案件のコーディングを経験しました。',
  ...
  },
  {
    ...
    title: 'スタートアップ',
    detail:
      '自社開発の業務支援ツールのフロントエンドエンジニア。業務支援ツールのフロントエンド開発や会社のプロダクトサイトの制作などをしました。',
    skills: [
      'Angular(1.x)',
      'React',
      'Sass',
  ...
  },
  {
    ...
    title: '制作会社',
    detail:
      '制作会社のフロントエンドエンジニア。受託開発で業務支援ツールの開発をしたり、コーポレートサイトやアーティストのサイトを制作しました。',
    skills: [
      'React',
      'EJS',
      'Sass',
  ...
  },
  {
    ...
    title: '制作会社',
    detail:
      '制作会社のフロントエンドエンジニア。コーディングだけでなく、フロントエンド業務全般の管理、技術ディレクション、技術サポートなどを行ってます。案件としては、コーポレート、教育機関、リクルート、キャンペーンなどのwebサイトや社内システムなどのwebアプリの制作に携わっています。',
    skills: [
      'EJS',
      'Pug',
      'Sass',
