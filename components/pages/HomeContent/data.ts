...
export const biographies = [
  ...
  },
  {
    ...
    title: '制作会社',
    detail:
      '制作会社でマークアップエンジニアをしました。大手のコーポレートサイトや会員制サービスサイトから、大学入試サイト、ECサイト、スマホゲームなど幅広い案件のコーディングを経験しました。',
  ...
  },
  {
    ...
    title: 'スタートアップ',
    detail:
      '自社で業務支援ツールを開発している会社でフロントエンドエンジニアをしました。業務支援ツールのフロントエンド開発や会社のプロダクトサイトの制作などをしました。',
    skills: [
      'Angular(1.x)',
      'React',
      'Sass',
  ...
  },
  {
    ...
    title: '制作会社',
    detail:
      '制作会社でフロントエンドエンジニアをしていました。受託開発で業務支援ツールの開発をしたり、コーポレートサイトやアーティストのサイトを制作しました。',
    skills: [
      'React',
      'EJS',
      'Sass',
  ...
  },
  {
    ...
    title: '制作会社',
    detail:
      '制作会社でフロントエンドエンジニアをしており、コーディングだけでなく、フロントエンド業務全般の管理、技術ディレクション、技術サポートなどを行ってます。案件としては、コーポレート、教育機関、リクルート、キャンペーンなどのwebサイトや社内システムなどのwebアプリの制作に携わっています。',
    skills: [
      'EJS',
      'Pug',
      'Sass',
