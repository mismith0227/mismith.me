...
export const ShareButton = (props: Props) => {
  ...
  return (
    <Link
      ...
      className={twMerge(
        'flex items-center justify-center h-12 w-12 text-lg no-underline bg-black text-white dark:bg-white dark:text-black transition-all duration-400 hover:rounded-[50%] rounded-md',
        className
      )}
    >
