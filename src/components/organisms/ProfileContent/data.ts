...
export const biographies = [
  ...
  },
  {
    ...
    title: '制作会社',
    detail:
      '制作会社でマークアップエンジニアをしました。大手のコーポレートサイトやサービスサイトから、大学入試サイト、ECサイト、スマホゲームなど幅広い案件のコーディングを経験しました。',
  ...
  },
  {
    ...
    title: 'スタートアップ',
    detail:
      '自社で業務支援ツールを開発している会社でフロントエンドエンジニアをしました。業務支援ツールのフロントエンド領域の開発や会社のプロダクトサイトの制作などをしました。',
    skills: [
      'Angular(1.x)',
      'React',
      'Sass',
